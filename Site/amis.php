...
<div id="form3" class="bodyx">
  ...
  if ($db_found) {
	...
	$sql = "SELECT  numero,nom,prenom FROM personne, amis WHERE personne.numero=amis.ami AND amis.utilisateur='$personne'";
	...
	//	$photo=$data['photo'];
	  //  echo '<img src="data:photo/png;base64,'.base64_encode($data['photo'] ) .'" />';
        ...
        echo "Numero: ".$data['numero'].'<br>';
         ...
         ?>   
        <a href="messages.html"><input type ="button" value="Message"/></a>
